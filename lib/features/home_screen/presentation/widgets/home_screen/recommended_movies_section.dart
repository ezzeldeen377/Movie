...
class RecommendedMoviesSection extends StatelessWidget {
  const RecommendedMoviesSection({required this.recommendedMovies, super.key});
                    ...
                    Expanded(
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return MovieItem(movie: recommendedMovies[index]);
                          }),
                    ),
                    BlocBuilder<HomeScreenViewModel, HomeScreenState>(
                        builder: (context, state) {
                      if (state.isRecommendedPagination) {
                        return SafeArea(
                          child: Center(
